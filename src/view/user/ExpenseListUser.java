 ...
 * @author TechCare
 */
public class ExpenseListUser extends javax.swing.JFrame {
    ...
    public ExpenseListUser(User user) {
        ExpenseListUser.user = user;
        initComponents();
  ...
  private void addEntry() {
    ...
    dispose();
    new ExpenseListUser(user).setVisible(true);
}
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        // TODO add your handling code here:
        UserDashboard ad = new UserDashboard(user);
        dispose();
        ad.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExpenseListUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
