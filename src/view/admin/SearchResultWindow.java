...
public class SearchResultWindow extends javax.swing.JFrame {
    ...
    private static List<User> searchResult;

    public SearchResultWindow(List<User> searchResults) {
    ...
    private void initComponents(List<User> searchResults) {
        tableModel = new UserTableModel();
        table = new JTable(tableModel);
        JScrollPane scrollPane = new JScrollPane(table);

        // Populate the table with search results
        for (User entry : searchResults) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchResultWindow(searchResult).setVisible(true);
            }
        });
    }
